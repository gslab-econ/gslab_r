...
#' @param fig_width Plot width in inches (numeric).
#' @param fig_height Plot height in inches (numeric).
...
BinScatter <- function(data, y_var, x_var, linpartial_var = NULL, binpartial_var = NULL, n_bins = 20,
                    ...
                    bar_width = 0.5, bar_size = 0.5, fig_width = 7, fig_height = 7, 
                    axis_title_x_size = NULL, axis_title_y_size = NULL, axis_text_size = NULL) {
